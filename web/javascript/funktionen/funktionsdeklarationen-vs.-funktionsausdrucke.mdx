---
title: "Funktionsdeklarationen vs. Funktionsausdrücke"
icon: "not-equal"
---
...
Das liegt am [Hoisting](/web/javascript/scope-und-kontext/hoisting-und-temporal-dead-zone-tdz), ein Konzept, mit dem wir uns später beschäftigen werden.
