...
alles Werte. Wie Sie sehen, haben sie alle unterschiedliche [Datentypen](/web/javascript/grundlagen/datentypen), sodass sie etwas anderes darstellen. `"Jonas"` zum Beispiel ist ein String.
